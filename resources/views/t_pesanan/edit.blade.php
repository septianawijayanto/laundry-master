                ...
                <form role="form" method="post" action="{{ url('transaksi-pesanan/'.$dt->id) }}">
                    ...
                    <div class="form-group {{$errors->has('customer_id') ? 'has-error' :''}}">
                        ...
                        <select name="customer_id" class="form-control" id="customer_id" require>
                            ...
                            <option value="{{$c->id}}" @if ($c->id===$dt->customer_id)
                                selected
                                @endif>{{$c->nama}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group {{$errors->has('paket_id') ? 'has-error' :''}}">
                        ...
                        <select name="paket_id" class="form-control" id="paket_id" require>
                            <option value="">-Pilih-</option>
                            @foreach($paket as $c)
                            <option value="{{$c->id}}" @if ($c->id===$dt->paket_id)
                                selected
                                @endif>{{$c->nama}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group {{$errors->has('berat') ? 'has-error' :''}}">
                        ...
                        <input type="number" name="berat" class="form-control" id="exampleInputPassword1" placeholder="" value="{{$dt->berat}}">
                        @if($errors->has('berat'))
                    ...
                    <div class="form-group {{$errors->has('status_pesanan_id') ? 'has-error' :''}}">
                        ...
                        <select name="status_pesanan_id" class="form-control" id="status_pesanan_id" require>
                            ...
                            <option value="{{$c->id}}" @if ($c->id===$dt->status_pesanan_id)
                                selected
                                @endif>{{$c->nama}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group {{$errors->has('status_pembayaran_id') ? 'has-error' :''}}">
                        ...
                        <select name="status_pembayaran_id" class="form-control" id="status_pembayaran_id" require>
                            ...
                            <option value="{{$c->id}}" @if ($c->id===$dt->status_pembayaran_id)
                                selected
                                @endif>{{$c->nama}}</option>
                            @endforeach
                        </select>
